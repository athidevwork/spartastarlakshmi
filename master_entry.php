...
<option value="8">ER</option>
				  ...
				  <?php 
					include("config_db1.php");
					$cmd = "select username,role,id from user_login order by username asc";
					$i=1;
			$res = mysql_query($cmd);
...
if($rs['role']==8)
			$role="ER";
						...
						<td><a href="#" name="editimg" class="btn btn-default btn-rounded btn-condensed btn-sm pull-left"><span class="fa fa-pencil"></span></a>&nbsp;&nbsp;
...
<a href="#" class="btn btn-primary pull-left" onClick="adduser()">Add <span class="fa fa-plus fa-right"></span></a>                                 </div>
	    <div class="col-md-2" style="display:none" id="editus">                                                     
<a href="#" class="btn btn-primary pull-left" onClick="saveuser()">Save Changes <span class="fa fa-floppy-o fa-right"></span></a>
</div>
...
<option value="8">ER</option>
                                        ...
                                        <div class="col-md-12">
											...
											<div class="form-group">
                                            <label class="col-md-5  control-label">Billing</label>
                                            <div class="col-md-4">
                                                <label class="switch">
                                                    <input type="checkbox" id="bill" value="0"/>
                                                    <span></span>
                                                </label>
										...
										<div class="form-group">
                                            <label class="col-md-5  control-label">Prescription Print</label>
                                            <div class="col-md-4">
                                                <label class="switch">
                                                    <input type="checkbox" id="both" value="0"/>
                                                    <span></span>
                                                </label>
										...
										<div class="col-md-12">
											...
											<div class="form-group">
                                            <label class="col-md-5  control-label">Edit Billing</label>
                                            <div class="col-md-4">
                                                <label class="switch">
                                                    <input type="checkbox" id="editbill" value="0"/>
                                                    <span></span>
                                                </label>
										...
										<div class="form-group">
                                            <label class="col-md-5  control-label">Print Requisition</label>
                                            <div class="col-md-4">
                                                <label class="switch">
                                                    <input type="checkbox" id="printreq" value="0"/>
                                                    <span></span>
                                                </label>
										...
										<div class="form-group">
                                            <label class="col-md-5  control-label">Communication</label>
                                            <div class="col-md-4">
                                                <label class="switch">
                                                    <input type="checkbox" id="comm" value="0"/>
                                                    <span></span>
                                                </label>
										...
										<div class="form-group">
                                            <label class="col-md-5  control-label">Clinical History</label>
                                            <div class="col-md-4">
                                                <label class="switch">
                                                    <input type="checkbox" id="clinical" value="0"/>
                                                    <span></span>
                                                </label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-5  control-label">Activity Chart</label>
                                            <div class="col-md-4">
                                                <label class="switch">
                                                    <input type="checkbox" id="activ" value="0"/>
                                                    <span></span>
                                                </label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-5  control-label">Chart OT</label>
                                            <div class="col-md-4">
                                                <label class="switch">
                                                    <input type="checkbox" id="chart_ot" value="0"/>
                                                    <span></span>
                                                </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <label class="switch">
                                                    <input type="checkbox" id="clinical_chart" value="0"/>
                                                    <span></span>
                                                </label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-5  control-label">Activity Chart for ICU</label>
                                            <div class="col-md-4">
                                                <label class="switch">
                                                    <input type="checkbox" id="icu" value="0"/>
                                                    <span></span>
                                                </label>
                  ...
                  <div class="form-group">
				    <div class="col-lg-2">                                              
<a href="#" class="btn btn-primary pull-left" onClick="saveset()">Save<span class="fa fa-floppy-o fa-right"></span></a>
</div></div></div>
...
<a href="#" class="btn btn-primary pull-left" onClick="addroom()">Add<span class="fa fa-plus fa-right"></span></a>                                           </div>
	    <div class="col-md-2" id="editroo" style="display:none">                                         
<a href="#" class="btn btn-primary pull-left" onClick="saveroom()">Save Changes <span class="fa fa-floppy-o fa-right"></span></a>
                                          </div>  
                                           <br>
                                           <br>
                                        </div>
	...
	<div class="row">	
		 ...
		 <div class="col-lg-12">
                  ...
                  <div class="form-group">
					...
					<div class="input-group"> 
                   <span class="input-group-addon"><span class="fa fa-pencil"></span> </span>                                          
										<input name="addnormal" class="form-control" type="text" id="addnormal"  placeholder="Normal Value"> </div>
                    </div>
                    <div class="col-lg-2">
...
if ($('#clinical').is(':checked')) 
clinical=1; 
else
clinical=0;

if ($('#clinical_chart').is(':checked')) 
clinical_chart=1; 
else
clinical_chart=0;
...
$.ajax({
			...
			if(x[1]==1)
			$('#editbill').iCheck('check');
			else
			$('#editbill').iCheck('uncheck');
			...
			$('#printbill').iCheck('uncheck');	//alert(msg);
				
				
			if(x[4]==1)
			$('#printreq').iCheck('check');
			else
			$('#printreq').iCheck('uncheck');
			...
			if(x[7]==1)
			$('#clinical').iCheck('check');
			else
			$('#clinical').iCheck('uncheck');
...
$('table').on('click', 'a[name="editimg"]', function (e) {
		if(confirm("Sure to edit record?")){
			var row = $(this).closest("tr");
