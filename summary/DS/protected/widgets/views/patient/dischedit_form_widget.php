...
<!--------------    Physical Activity  -------------->
    ...
    <div class="row-form">
      ...
      <div class="span10"> 
      <?php
	  if($model1->on_examination=='')
	  {
     $on_examination_table = '<table border="1" cellpadding="1" cellspacing="1" style="width:90%;">
	<tbody>
		<tr>
...
else{$on_examination_table=$model1->on_examination;}
...
<!--------------    Medication  -------------->
    <div id="tabs-5">
		 ...
		 if($model1->investigation =='')
		 {
     $investigation_table = '<table border="1" cellpadding="1" cellspacing="1" style="width:90%;">
	<tbody>
		<tr>
			<td align="center" width="7%">
				S.No</td>
...
else{$investigation_table=$model1-> investigation;}
