      ...
      <div class="span6">
        ...
        <div class="block-fluid">
          ...
          <div class="row-form">
            ...
            <div class="span7"> <?php echo $form->dropDownList($model,'source',  Cabin::GetAll(),array()); ?> <span><?php echo $form->error($model,'status'); ?> </span> </div>
            <div class="clear"></div>
          </div>
...
<?php $this->render('cmswidgets.views.bed.bed_form_javascript',array('model'=>$model,'form'=>$form)); ?>
