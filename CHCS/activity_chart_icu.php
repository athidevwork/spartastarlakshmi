...
function add_service1(service,service_no,ref_no)
{
	if ($('#service_no').val() == "") {
...
function add_procedures1(procedures,procedure_no,ref_no)
{
	if ($('#procedure_no').val() == "") {
...
function add_consulting_detail1(depart,consultant,visit,ref_no)
{
		if ($('#depart').val() == "") {
...
function add_chart_ot1(room_no,name,age,doa,cons,intimedate,chart_ot_no,description,shift_patient,outtime,vacant_chk)
{
		$.ajax({
			type: "post",
			url: "addcharticu.php", 
...
<div class="page-content-wrap">                
  ...
  <div class="form-group">
			<div class="col-md-3">
                ...
                <div class="col-md-4">
                      <input type="text" style="width:90px;font-weight:bold"  class="form-control" name="room_no" id="room_no" value="<?php echo $room;?>"/>
            ...
            <div class="col-md-2">
               ...
               <div class="col-md-5">
                    <input type="text" style="font-weight:bold;width:110px;"  class="form-control" name="pat_name" id="pat_name" value="<?php echo $patientname?>"/>
                    <span class="help-block"></span>  
			   </div>                                        
			</div>       
            ...
            <div class="col-md-3">
                ...
                <div class="col-md-5">
                    <input type="text" style="font-weight:bold;width:110px;"  class="form-control" name="age" value="<?php echo $age?>"/>
                    <span class="help-block"></span> 
                </div>                                        
            </div>
            ...
            <div class="col-md-2">
                ...
                <div class="col-md-5">
                    <input type="text" style="font-weight:bold;width:110px;"  class="form-control" name="doa" value="<?php echo date('d-m-Y',strtotime($create_date));?>"/>
                    <span class="help-block"></span> 
                </div>                                        
            </div>
            ...
            <div class="col-md-2">
                ...
                <div class="col-md-5">
                    <input type="text" style="font-weight:bold;width:110px;"  class="form-control" name="cons" value="<?php echo $consultant?>"/>
                    <span class="help-block"></span> 
                </div>                                        
            </div>
		</div>	
...
<!-- 2 ROW END  --> 
        ...
        <div class="form-group">
            ...
            <div class="col-md-1">
                <a href="#"  onClick="add_service1(service.value,service_no.value,chart_ot_no.value);" class="btn btn-default btn-rounded btn-condensed btn-sm pull-right"><span class="fa fa-plus"></span></a>            </div>   
            ...
            <div class="col-md-1">
                <a href="#"  onClick="add_procedures1(procedures.value,procedure_no.value,chart_ot_no.value);" class="btn btn-default btn-rounded btn-condensed btn-sm pull-right"><span class="fa fa-plus"></span></a>            </div>   
...
<!-- 4 ROW END  -->    
        ...
        <div class="form-group">
            ...
            <div class="col-md-1">
                <a href="#"  onClick="add_consulting_detail1(depart.value,consultant.value,visit.value,chart_ot_no.value);" class="btn btn-default btn-rounded btn-condensed btn-sm pull-right"><span class="fa fa-plus"></span></a>            </div>                                    
		</div>	
<!-- 5 ROW END  -->  
...
<!-- 9 ROW END  -->  
                                        ...
                                        <input name="submit" id="submit" class="btn btn-primary" value="submit" type="button" onClick="add_chart_ot1(room_no.value,pat_name.value,age.value,doa.value,cons.value,intimedate.value,chart_ot_no.value,description.value,shift_patient.value,outtime.value,vacant_chk.value)">
                                                   </div>
