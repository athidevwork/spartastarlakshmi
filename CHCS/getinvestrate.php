...
echo "<tr>
		...
		<td class='nor' ><div id='report_edit".$i."'>".$rs1['normal']."</div><a href='#labsampletestreportedit_modal' data-toggle='modal' data-id='report_edit".$i."' onclick='edit_lab_normal(this);return false;'><span class='pencil glyphicon glyphicon-pencil' style='float:right;'></span></a></td>
