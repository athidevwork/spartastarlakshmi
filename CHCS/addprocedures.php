...
include("config_db2.php");
	...
	if($procedures != "")
	{
        $cmd = "INSERT INTO procedure_details (id,ref_no,insert_from,procedure_id,procedure_name,duration,count,given_details,total_count,created_date,consultant,fees_amount,patient_id,ip_no) VALUES (NULL, '$ref_no','CHART OT','$id','$procedure_name','$types','$count','$procedure_no','$total','$created_date','$consultant','$fees_amount','$patient_id','$mrd_no')";
