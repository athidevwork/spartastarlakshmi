...
include("config_db2.php");
	...
	if($service != "")
	{
		$cmd = "INSERT INTO services_details (id,ref_no,insert_from,service_id,service_name,duration,count,given_details,total_count,created_date,patient_id,ip_no) VALUES (NULL, '$ref_no','CHART OT','$id','$service_name','$types','$count','$service_no','$total','$created_date','$patient_id','$mrd_no')";
		$cmds=mysql_query($cmd);
		$insert_id = mysql_insert_id();
	    $cmd1 = mysql_query("INSERT INTO fees_details (id,patient_id,pat_name,ip_id,description,fees,created_date,insert_from,insert_id) VALUES (NULL, '$patient_id','$patient_name','$mrd_no','$service_name','$total','$created_date','CHART OT','$insert_id')");
	}
