...
<head>
<!-- META SECTION -->
<title>DPP - Master Entry Page</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
...
<body>
      ...
      <li class="xn-icon-button pull-right"><a href="#"><span
					...
					<div
						...
						<div class="panel-heading">
							...
							<div class="pull-right">
								<span class="label label-warning"><?php echo $cnt ?> active</span>
							</div>
						</div>
		   ...
		   <?php
			...
			<ul class="breadcrumb">
				...
				<li><a href="master_entry.php">Settings</a></li>
			</ul>
			<!-- END BREADCRUMB -->
						...
						<div class="panel panel-default tabs">
							<ul class="nav nav-tabs" role="tablist">
								<li class="active"><a href="#tab-first" role="tab"
									data-toggle="tab">Modify Table</a></li>
								<li><a href="#tab-second" role="tab" data-toggle="tab">Manage
										Users</a></li>
								<li><a href="#tab-third" role="tab" data-toggle="tab">User
										Settings</a></li>
								...
								<li><a href="#tab-fourteen" role="tab" data-toggle="tab">Type
										Creation</a></li>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<div class="form-group">
												<div class="col-lg-6">
													<select name="sel_table" class="form-control select"
														id="sel_table">
													...
													</select> <span class="help-block">Select Table to Modify</span>

												</div>
												<div class="col-lg-6">
													<select name="sel_content" id="sel_content"
														class="form-control select" style="width: 250px">
														<option></option>
													</select> <span class="help-block">Current Text</span>
												...
												<div class="col-lg-6">
													<div class="input-group">
														...
														<input type="text" name="newtxt"
															placeholder="Text to Update" id="newtxt"
															class="form-control" />
													</div>
											...
											<div class="form-group">
												<div class="col-lg-2">
													...
													<a href="#" onClick="update()"
														...
														class="fa fa-floppy-o fa-right"></span>Save Changes</a>
												</div>
												<div class="col-lg-2">

													<a href="#" onClick="del()"
														class="btn btn-primary pull-left">Delete </a>
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="input-group">
													<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
													<input type="text" name="user_real_name" placeholder="Name"
														id="user_real_name" class="form-control" />
												</div>
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" name="password" placeholder="Password"
														id="password" class="form-control" /> <input type="hidden"
														name="id" placeholder="Password" id="id"
														class="form-control" />
												</div>
											...
											<?php } ?>
											</select> <span class="help-block">Select Role</span>

											</div>
											<br>
											<div class="col-md-2" id="addus">
												<a href="#" class="btn btn-primary pull-left"
													onClick="adduser();return false;">Add <span
													class="fa fa-plus fa-right"></span></a>
											</div>
											<div class="col-md-2" style="display: none" id="editus">
												<a href="#" class="btn btn-primary pull-left"
													onClick="saveuser();return false;">Save Changes <span
								...
								<div class="tab-pane" id="tab-third">
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group">
												<div class="col-lg-6">
													<select name="role1" id="role1" onChange="getset()"
														class="form-control select" style="width: 200px;">
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox" id="billip"
														value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox" id="billop"
														value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox" id="report"
														value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox"
														id="lab_reports_perm" value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox"
														id="printbill" value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox" id="master"
														value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox" id="reg"
														value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox"
														id="complaints_perm" value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox"
														id="activechart_perm" value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox"
														id="clinicalchart_perm" value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox"
														id="medication_perm" value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox"
														id="investigation_perm" value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox" id="info"
														value="0" /> <span></span>
													</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<label class="switch"> <input type="checkbox"
														id="admission_perm" value="0" /> <span></span>
													</label>
										...
										<div class="col-lg-12">
											<div class="form-group">
												<div class="col-lg-2">
													<a href="#" class="btn btn-primary pull-left"
														onClick="saveset();return false;">Save<span
														class="fa fa-floppy-o fa-right"></span></a>
												</div>
											</div>
										</div>
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" name="branchid" placeholder="Branch ID"
														id="branchid" readonly class="form-control" />
				  ...
				  <?php
						...
						?>
									...
									<div class="col-md-2" id="addbra">
										<a href="#" class="btn btn-primary pull-left"
											onClick="addbranch()">Add<span class="fa fa-plus fa-right"></span></a>
									</div>
									<div class="col-md-2" id="editbr" style="display: none">
										<a href="#" class="btn btn-primary pull-left"
											onClick="savebranch()">Save Changes <span
											class="fa fa-floppy-o fa-right"></span></a>
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" name="ward_name" placeholder="Ward Name"
														id="ward_name" class="form-control" />
				  ...
				  <?php
						...
						?>
									...
									<div class="col-md-2" id="addwar">
										<a href="#" class="btn btn-primary pull-left"
											onClick="addward()">Add<span class="fa fa-plus fa-right"></span></a>
									</div>
									<div class="col-md-2" id="editwar" style="display: none">
										<a href="#" class="btn btn-primary pull-left"
											onClick="saveward()">Save Changes <span
											class="fa fa-floppy-o fa-right"></span></a>
								...
								<div class="tab-pane" id="tab-six">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<div class="col-lg-12">
													<select name="ward_names" id="ward_names"
														class="form-control select" style="width: 200px;">
 ...
 <?php
	...
	while ( $rsdata = mysql_fetch_array ( $rs ) ) {
		...
		$id = $rsdata ['id'];
		?>
    <option value="<?php echo $id;?>"><?php echo $ward_names;?></option><?php }?></select>
												</div>
				  ...
				  <?php
						...
						?>
									...
									<div class="col-md-2" id="addroo">
										<a href="#" class="btn btn-primary pull-left"
											onClick="addroom();return false;">Add<span
											class="fa fa-plus fa-right"></span></a>
									</div>
									<div class="col-md-2" id="editroo" style="display: none">
										<a href="#" class="btn btn-primary pull-left"
											onClick="saveroom();return false;">Save Changes <span
											class="fa fa-floppy-o fa-right"></span></a>
									</div>
									<br> <br>
								</div>
				  ...
				  <?php
						...
						?>
									...
									<div class="col-md-2" id="addser">
										<a href="#" class="btn btn-primary pull-left"
											onClick="addservice()">Add<span class="fa fa-plus fa-right"></span></a>
									</div>
									<div class="col-md-2" id="editser" style="display: none">
										<a href="#" class="btn btn-primary pull-left"
											onClick="saveservice()">Save Changes <span
											class="fa fa-floppy-o fa-right"></span></a>
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" name="procedure_name"
														placeholder="Procedure Name" id="procedure_name"
														class="form-control" />
											...
											<div class="form-group">
												...
												<div class="input-group">
													<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
													<input type="text" name="pamount" placeholder="Amount"
														id="pamount" class="form-control"
														onKeyPress="if ((event.keyCode &lt; 48) || (event.keyCode &gt; 57)) event.returnValue = false" />
				  ...
				  <?php
						...
						?>
									...
									<div class="col-md-2" id="addproc">
										<a href="#" class="btn btn-primary pull-left"
											onClick="addprocedure()">Add<span class="fa fa-plus fa-right"></span></a>
									</div>
									<div class="col-md-2" id="editproc" style="display: none">
										<a href="#" class="btn btn-primary pull-left"
											onClick="saveprocedure()">Save Changes <span
											class="fa fa-floppy-o fa-right"></span></a>
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="input-group">
													<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
													<input type="text" name="visit_name"
														placeholder="Visit Name" id="visit_name"
														class="form-control" />
											...
											<div class="form-group">
												...
												<div class="input-group">
													<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
													<input type="text" name="vamount" placeholder="Amount"
														id="vamount" class="form-control"
														onKeyPress="if ((event.keyCode &lt; 48) || (event.keyCode &gt; 57)) event.returnValue = false" />
				  ...
				  <?php
						...
						?>
									...
									<div class="col-md-2" id="addvis">
										<a href="#" class="btn btn-primary pull-left"
											onClick="addvisit()">Add<span class="fa fa-plus fa-right"></span></a>
									</div>
									<div class="col-md-2" id="editvis" style="display: none">
										<a href="#" class="btn btn-primary pull-left"
											onClick="savevisit()">Save Changes <span
											class="fa fa-floppy-o fa-right"></span></a>
								...
								<div class="tab-pane" id="tab-ten">
									<form enctype="multipart/form-data" method="post"
										name="uploadheader" action="uploadhed.php">
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													<div class="col-md-12">
														<input type="file" class="fileinput form-control btn-info"
															id="header" name="header" onChange="readURL(this);" /> <span
															class="help-block">Browse Header file</span><br> <br /> <img
															style="float: right; cursor: pointer; margin-right: 30px"
															src="return_print_image.php?type=header" height="200"
															width="200" id="img_prev" name="img_prev" />
			...
			if (input.files && input.files[0]) {
				...
				reader.readAsDataURL(input.files[0]);
												...
												<div class="form-group">
													...
													<div class="col-md-12">
														<br> <input type="file"
															class="fileinput form-control btn-info" id="footer"
															name="footer" onChange="readURL1(this);" /> <span
															class="help-block">Browse Footer file</span><br> <br> <img
															style="float: right; cursor: pointer; margin-right: 30px"
															src="return_print_image.php?type=footer" height="200"
															width="200" id="img_prev1" name="img_prev1" />
									...
									<div class="row">
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												...
												?>
                                                    <input
														type="checkbox" <?php echo $lac_check;?> id="lab"
														value="0" /> <span></span>
													</label>
										...
										<div class="form-group">
											...
											<div class="col-md-5 col-xs-12">
												<select id="inves" onChange="investigation()"
												...
												</select> <span class="help-block">Select Investigation </span>
		...
		investigation();
										...
										<div class="col-lg-12">
											<div class="form-group">
												<div class="col-lg-2">
													<a href="#" class="btn btn-primary pull-left"
														onClick="savelab()">Save Changes <span
														class="fa fa-floppy-o fa-right"></span></a>
												</div>
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" name="department_names"
														placeholder="Department Name" id="department_names"
														class="form-control" />
											...
											<div class="form-group">
												...
												<div class="input-group">
													<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
													<textarea name="description" placeholder="Descriptions"
														id="descriptions" class="form-control"></textarea>
												</div>
												<span class="help-block">Enter Description</span>
											</div>
				  ...
				  <?php
						...
						?>
									...
									<div class="col-md-2" id="adddepart">
										<a href="#" class="btn btn-primary pull-left"
											onClick="adddept()">Add<span class="fa fa-plus fa-right"></span></a>
									</div>
									<div class="col-md-2" id="editdepart" style="display: none">
										<a href="#" class="btn btn-primary pull-left"
											onClick="savedept()">Save Changes <span
											class="fa fa-floppy-o fa-right"></span></a>
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" name="type_name" placeholder="Type Name"
														id="type_name" class="form-control" />
				  ...
				  <?php
						...
						?>
									...
									<div class="col-md-2" id="addtypess">
										<a href="#" class="btn btn-primary pull-left"
											onClick="addtype()">Add<span class="fa fa-plus fa-right"></span></a>
									</div>
									<div class="col-md-2" id="edittypess" style="display: none">
										<a href="#" class="btn btn-primary pull-left"
											onClick="savetype()">Save Changes <span
											class="fa fa-floppy-o fa-right"></span></a>
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" name="doctor_name"
														placeholder="Doctor Name" id="doctor_name"
														class="form-control" />
				  ...
				  <?php
						...
						?>
									...
									<div class="col-md-2" id="adddoc">
										<a href="#" class="btn btn-primary pull-left"
											onClick="adddoctor()">Add<span class="fa fa-plus fa-right"></span></a>
									</div>
									<div class="col-md-2" id="editdoc" style="display: none">
										<a href="#" class="btn btn-primary pull-left"
											onClick="savedoctor()">Save Changes <span
											class="fa fa-floppy-o fa-right"></span></a>
									</div>
									<br> <br>
								</div>
		...
		<div class="modal-dialog modal-lg ">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id='add_update_lab_report_save' data-id=''
					...
					<div class="col-md-12">
							...
							<div class="row">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<div class="col-lg-10">
											<div class="input-group">
												<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
												<input name="addtest" type="text" id="addtest"
								...
								<div class="col-lg-12">
									<div class="form-group">
										<div class="col-lg-10">
											<div class="input-group">
												<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
												<input name="addrate" class="form-control" type="text"
													id="addrate" placeholder="Rate">
											</div>
										</div>
										<div class="col-lg-2"></div>
									</div>
								...
								<div class="col-lg-12">
									<div class="form-group">
										<div class="col-lg-10">
											<div class="input-group">
												<span class="help-block">Normal Value</span> <input
													name="addnormal" class="form-control txtEditor_add"
													type="text" id="addnormal" placeholder="Normal Value">
											</div>
										</div>
										<div class="col-lg-2"></div>
									</div>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-default"
								onClick="addnewtest()" data-dismiss="modal">Save</button>
							<button type="button" class="btn btn-default"
...
// Get table content and display in current text listbox
	...
	//alert(x);
		...
		$.ajax({
			...
			success: function(msg) {
				...
				//window.location.href = "master_entry.php";
				//window.location.href = "http://localhost/CHCS/master_entry.php#tab-four";
				//window.location.href = "http://localhost/CHCS/master_entry.php#";
				//header( "refresh:1; url=http://localhost/CHCS/master_entry.php#" );
				//header( "location:http://localhost/CHCS/master_entry.php#" ); 		
			}
		});
		}
	}
	...
	function delete_ward(x){
		if(confirm("Are you sure to delete ward?")){
		$.ajax({
			type: "post",
	...
	function delete_service(x){
		if(confirm("Sure to delete service?")){
		$.ajax({
			type: "post",
	...
	function delete_procedure(x){
		if(confirm("Sure to delete procedure?")){
		$.ajax({
			type: "post",
	...
	function delete_visit(x){
		if(confirm("Sure to delete visit?")){
		$.ajax({
			type: "post",
	...
	function delete_dept(x){
		if(confirm("Sure to delete dept?")){
		$.ajax({
			type: "post",
