...
<div id="reportadd"  class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
	...
	//alert('');
		...
		//alert(x[7]);
		if(x1[7]==1) {
		var pen='<a href="#" name="editimg" onclick="addreport('+x1[8]+')" class="btn btn-default btn-rounded btn-condensed btn-sm pull-left"><span class="fa fa-plus"></span></a>';
		var fd='false';
		}
		else {
		pen='Pending';
		...
		var txt = "<tr><td>"+s+"</td><td>"+x1[0]+"</td><td contenteditable='"+fd+"'>"+pen+"</td><td contenteditable='true'>"+x1[2]+"</td><td style='display:none'>"+x1[5]+"</td><td>"+x1[3]+"</td><td style='display:none'>"+x1[4]+"</td><td style='display:none'>"+x1[6]+"</td><td style='display:none'>"+x1[7]+"</td></tr>";
