...
?>
						...
						<!-- START TIMELINE -->
							...
							<?php
							$cdquery = "SELECT id,type,typeid,patientid,message,date FROM timeline WHERE patientid='$pid' ORDER BY date DESC";
							//echo $query1;
							$index = 1;
							...
							$cd = mysql_query($cdquery);
									...
									$dbresult_array = array('time'=>$time,'','timeline_id'=>$timeline_id,'timeline_type'=>$timeline_type,'timeline_message'=>$timeline_message);
