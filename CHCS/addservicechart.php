...
include("config_db2.php");
	...
	if($service != ""){
		...
		$cmd = "INSERT INTO services_details (id,ref_no,insert_from,service_id,service_name,duration,count,given_details,total_count,created_date,patient_id,ip_no,added_by) VALUES (NULL, '$ref_no','CHART','$id','$service_name','$types','$count','$service_no','$total','$created_date','$patient_id','$mrd_no','$user')";
