                        ...
                        <div class="col-md-12">
                                ...
                                <div class="panel panel-default tabs">                            
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">LAB Sample List</a></li>
										<li><a href="#tab-second" role="tab" data-toggle="tab">LAB Reports</a></li>
      ...
      <tbody>
		...
		<div class="tab-pane" id="tab-second">
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-3">
											<select name="select_rpt_type" id="select_rpt_type" class="select" style="font-weight:bold;width:160px;">
...
echo date('Y-m-d', $date); ?> "/>
												...
												<div class="col-md-3">
												<a href="#" class="btn btn-primary pull-left" onClick="getsamplereportstable()">Search <span class="fa fa-floppy-o fa-right"></span></a>
												</div>
                                            </div>
											</form>
                                        </div>
...
<input type="hidden" id="txtEditor_normal_id">  
<div class="txtEditor"></div>		  
      ...
      <div class="modal-footer">
		...
		<button type="button" id='update_lab_report_revert_to_default' data-id='' class="btn btn-primary" onclick="update_lab_report_revert_to_default();return false;">Reset to Default</button>
...
<div id="myModal_infomsg" class="modal fade" role="dialog">
  <div class="modal-dialog">
		 ...
		 <div class="message-box message-box-info animated fadeIn" id="message-box-info">
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <button class="btn btn-default btn-lg pull-right mb-control-close"  data-dismiss="message-box">Close</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- START SCRIPTS -->
		...
		<script type="text/javascript" src="js/plugins/jquery/jquery.ui.dialog.patch.js"></script>
