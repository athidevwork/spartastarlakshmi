...
$activitychart=$sql['activechart'];
$investigation=$sql['investigation'];
$medication=$sql['medication'];
$reqrights=$sql['print_request'];
$prerights=$sql['medication'];
if($sql['complaints'] !=1)
{
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <ul class="nav nav-tabs" role="tablist">
       <?php if($activitychart==1 && !empty($inv_pat_id)) {?><li id="1" class="active"><a href="#tab-first"  role="tab" data-toggle="tab">Activity IP Chart</a></li><?php } ?>
	   <?php if($activitychart==1 && empty($inv_pat_id)) {?><li id="1" class="active"><a href="#tab-fourth"  role="tab" data-toggle="tab">Activity OP Chart</a></li><?php } ?>
        <?php if($clinicalchart==1) {?> <li id="2"><a href="#tab-second" role="tab" data-toggle="tab">Clinical Chart</a></li><?php } ?>
        <?php if($investigation==1) {?> <li id="3"><a href="#tab-third" role="tab" data-toggle="tab">Investigation</a></li><?php } ?>
		 <?php if($medication==1) {?><li id="5"><a href="#tab-five" role="tab" data-toggle="tab">Medication</a></li><?php } ?>
...
<div class="tab-pane <?php if(!empty($inv_pat_id) && $activitychart ==1) { echo 'active'; } ?>" id="tab-first">
        <div class="row">
          <div class="col-md-12">
     ...
     <span class="help-block"></span>  
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-1">
                    ...
                    <input type="datetime" style="font-weight:bold;width:160px;"  class="form-control" name="intimedate2" id="intimedate2" value="<?php echo date("d-m-Y H:i:s");?>"/>
                </div>                                        
												   </div></div>
       ...
       <div class="panel panel-default" style="background-color: rgb(238, 238, 238)">
           <div class="panel-heading"  style="background: rgb(201, 221, 240) none repeat scroll 0% 0%;">
            <div class="panel-title-box">
              <h3 style="color:#0000">Services</h3>
             </div>
          </div>
          <div class="panel-body">		
            ...
            <div class="col-md-3">
				...
				<center>
                        ...
                        <table id="dataTables-example" class="table table-striped table-bordered table-hover" width="30%" style="background-color:#FFFFFF">
                        <thead>
                        <tr>
                        <th>#</th>
                        <th>Services</th>
                        ...
                        <tbody>
                         <?php 
					include("config_db2.php");
					$cmd = "select * from services_details where patient_id='$patient_id'";
					$i=1;
					$res = mysql_query($cmd);
					while($rs = mysql_fetch_array($res)){
						$insert_from='CHART';
       ...
       <div class="panel panel-default" style="background-color: rgb(238, 238, 238)">
           <div class="panel-heading"  style="background: rgb(201, 221, 240) none repeat scroll 0% 0%;">
            <div class="panel-title-box">
              <h3 style="color:#0000">Operation Threatre</h3>
             </div>
          </div>
          <div class="panel-body">		
									<div class="form-group">				   
 ...
 if($pat_ip_status !=1){
  ?>
       ...
       <div class="panel panel-default" style="background-color: rgb(238, 238, 238)">
           <div class="panel-heading"  style="background: rgb(201, 221, 240) none repeat scroll 0% 0%;">
            <div class="panel-title-box">
              <h3 style="color:#0000">Consultent Visit</h3>
             </div>
          </div>
          <div class="panel-body">		
  ...
  ?>  
            ...
            <div class="col-md-10">
                ...
                <div id="consultant2_list_div">
					<table id="dataTables-example" class="table table-striped table-bordered table-hover" style="background-color:#FFFFFF">
                        <thead>
                        <tr>
                        <th>#</th>
                        <th>Department</th>
		...
		<h3>Room Details</h3>
					...
					$cmd = "select room_id,from_time,to_time from room_bill_details where ip_no='$inv_pat_id'";
					$i=1;
					$res = mysql_query($cmd);
					while($rs = mysql_fetch_array($res)){
						$rm_id = $rs['room_id'];
         ...
         <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-1">
					...
					include("config_db1.php");
					$cmd = "select * from room_no WHERE vacant ='' OR vacant ='$inv_pat_id' OR vacant='yes'";
					$i=1;
					$res = mysql_query($cmd);
					while($rs = mysql_fetch_array($res)){
						?>
...
<!-- 7 ROW END  -->  
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-1">
                    <input type="datetime" style="font-weight:bold;width:160px;"  class="form-control" name="outtime2" id="outtime2" value="<?php echo date("d-m-Y H:i:s");?>"/>
                </div> 
            </div>                
        </div>
<!-- 9 ROW END  -->  
						...
						<?php
						include("config_db2.php");
							$cdquery = "SELECT id,type_name,sitting,added_by,created_date FROM sitting_details WHERE patient_id='$pid' AND ip_no='$inv_pat_id' ORDER BY id DESC";
							...
							$cd = mysql_query($cdquery);
									...
									$date=date("Y-m-d",strtotime($cd1['created_date']));
									
									$time=date("h:i-A",strtotime($cd1['created_date']));
									$timeline_id=$cd1['id'];
									$timeline_type_name=$cd1['type_name'];
									$timeline_sitting=$cd1['sitting'];
									$timeline_added_by=$cd1['added_by'];
									$timeline_message='sitting';
									$dbresult_array[$date]['sitting'][] = array('time'=>$time,'','timeline_id'=>$timeline_id,'timeline_type_name'=>$timeline_type_name,'timeline_sitting'=>$timeline_sitting,'timeline_added_by'=>$timeline_added_by,'timeline_message'=>$timeline_message);
									
									}
					$cdquery = "SELECT id,service_name,duration,given_details,added_by,created_date FROM services_details WHERE patient_id='$pid' AND ip_no='$inv_pat_id' ORDER BY id DESC";
							...
							$cd = mysql_query($cdquery);
									...
									$time=date("h:i-A",strtotime($cd1['created_date']));
									$timeline_id=$cd1['id'];
									$timeline_service_name=$cd1['service_name'];
									$timeline_duration=$cd1['duration'];
									$timeline_given_details=$cd1['given_details'];
									$timeline_added_by=$cd1['added_by'];
									$timeline_message='services';
									$dbresult_array[$date]['services'][] = array('time'=>$time,'','timeline_id'=>$timeline_id,'timeline_service_name'=>$timeline_service_name,'timeline_duration'=>$timeline_duration,'timeline_given_details'=>$timeline_given_details,'timeline_added_by'=>$timeline_added_by,'timeline_message'=>$timeline_message);
									
									}
					$cdquery = "SELECT id,procedure_name,duration,given_details,consultant,fees_amount,added_by,created_date FROM procedure_details WHERE patient_id='$pid' AND ip_no='$inv_pat_id' ORDER BY id DESC";
							...
							$cd = mysql_query($cdquery);
									...
									$time=date("h:i-A",strtotime($cd1['created_date']));
									$timeline_id=$cd1['id'];
									$timeline_procedure_name=$cd1['procedure_name'];
									$timeline_duration=$cd1['duration'];
									$timeline_given_details=$cd1['given_details'];
									$timeline_consultant=$cd1['consultant'];
									$timeline_fees_amount=$cd1['fees_amount'];
									$timeline_added_by=$cd1['added_by'];
									$timeline_message='procedures';
									$dbresult_array[$date]['procedures'][] = array('time'=>$time,'','timeline_id'=>$timeline_id,'timeline_procedure_name'=>$timeline_procedure_name,'timeline_duration'=>$timeline_duration,'timeline_given_details'=>$timeline_given_details,'timeline_consultant'=>$timeline_consultant,'timeline_fees_amount'=>$timeline_fees_amount,'timeline_added_by'=>$timeline_added_by,'timeline_message'=>$timeline_message);
									
									}
					$cdquery = "SELECT id,department,consultant,visit,added_by,created_date FROM consultant_details WHERE patient_id='$pid' AND ip_no='$inv_pat_id' ORDER BY id DESC";
							...
							$cd = mysql_query($cdquery);
									...
									$time=date("h:i-A",strtotime($cd1['created_date']));
									$timeline_id=$cd1['id'];
									$timeline_department=get_dept_names($cd1['department']);
									$timeline_visit=get_visit_names($cd1['visit']);
									
									$timeline_consultant=get_consult_names($cd1['consultant']);
									
									$timeline_added_by=$cd1['added_by'];
									$timeline_message='consultant';
									$dbresult_array[$date]['consultant'][] = array('time'=>$time,'','timeline_id'=>$timeline_id,'timeline_department'=>$timeline_department,'timeline_visit'=>$timeline_visit,'timeline_consultant'=>$timeline_consultant,'timeline_added_by'=>$timeline_added_by,'timeline_message'=>$timeline_message);
									
									}
					$cdquery = "SELECT id,room_id,from_time,to_time,added_by,created_date,update_date FROM room_bill_details WHERE patient_id='$pid' AND ip_no='$inv_pat_id' ORDER BY id DESC";
							...
							$cd = mysql_query($cdquery);
									...
									$date=date("Y-m-d",strtotime($cd1['update_date']));
									
									$time=date("h:i-A",strtotime($cd1['update_date']));
									$timeline_id=$cd1['id'];
									$timeline_room_name=get_room_name($cd1['room_id']);
									$timeline_from_time=$cd1['from_time'];
									$timeline_to_time=$cd1['to_time'];
									$timeline_added_by=$cd1['added_by'];
									$timeline_message='room';
									$dbresult_array[$date]['room'][] = array('time'=>$time,'','timeline_id'=>$timeline_id,'timeline_room_name'=>$timeline_room_name,'timeline_from_time'=>$timeline_from_time,'timeline_to_time'=>$timeline_to_time,'timeline_added_by'=>$timeline_added_by,'timeline_message'=>$timeline_message);
									
									}
									$timeline_array=$dbresult_array;
									
									//print '<pre>';print_r($timeline_array);print '</pre>';
									
									foreach($timeline_array as $key => $value_array){
										
										$date = $key;
										$sitting_array = $value_array['sitting'];
										$room_array = $value_array['room'];
										$consultant_array = $value_array['consultant'];
										$procedures_array = $value_array['procedures'];
										$services_array = $value_array['services'];
										echo '<div class="panel panel-default">
                                
                                <div class="panel-body faq">
								<div class="faq-item">
								<div class="faq-title"><span class="fa fa-angle-down"></span>'.$date.'
										 </div>';
										 if(!empty($services_array)){
										 echo '<div class="faq-text">';
										  echo '<label>Services Details</label>';
										 echo '<table class="table table-striped table-bordered table-hover" width="30%">
														...
														<tbody>';
										foreach($services_array as $key => $values){
											
											$time=$values['time'];
											$timeline_service_name=$values['timeline_service_name'];
											$timeline_duration=$values['timeline_duration'];
											$timeline_given_details=$values['timeline_given_details'];
											
												
													echo '<tr><td>'.$timeline_service_name.'</td><td>'.$timeline_duration.'</td><td>'.$timeline_given_details.'</td></tr>';
										...
										echo '</div>';
										 ...
										 if(!empty($procedures_array)){
										 echo '<div class="faq-text">';
										  echo '<label>Procedure Details</label>';
										 echo '<table class="table table-striped table-bordered table-hover" width="30%">
														<thead>
														<tr>
														...
														<tbody>';
										foreach($procedures_array as $key => $values){
											
											$time=$values['time'];
											$timeline_procedure_name=$values['timeline_procedure_name'];
											$timeline_duration=$values['timeline_duration'];
											$timeline_given_details=$values['timeline_given_details'];
											$timeline_consultant=$values['timeline_consultant'];
												
													echo '<tr><td>'.$timeline_procedure_name.'</td><td>'.$timeline_duration.'</td><td>'.$timeline_given_details.'</td><td>'.$timeline_consultant.'</td></tr>';
										...
										echo '</div>';
										 ...
										 if(!empty($consultant_array)){
										 echo '<div class="faq-text">';
										  echo '<label>Consultant Details</label>';
										 echo '<table class="table table-striped table-bordered table-hover" width="30%">
														<thead>
														<tr>
														...
														<tbody>';
										foreach($consultant_array as $key => $values){
											$time=$values['time'];
											$timeline_department=$values['timeline_department'];
											$timeline_visit=$values['timeline_visit'];
											$timeline_consultant=$values['timeline_consultant'];
												
													echo '<tr><td>'.$timeline_department.'</td><td>'.$timeline_consultant.'</td><td>'.$timeline_visit.'</td></tr>';
										...
										echo '</div>';
										 ...
										 echo '<table class="table table-striped table-bordered table-hover" width="30%">
														...
														<tbody>';
										foreach($room_array as $key => $values){
											$time=$values['time'];
											$timeline_room_name=$values['timeline_room_name'];
											$timeline_from_time=$values['timeline_from_time'];
											$timeline_to_time=$values['timeline_to_time'];
												
													echo '<tr><td>'.$timeline_room_name.'</td><td>'.$timeline_from_time.'</td><td>'.$timeline_to_time.'</td></tr>';
										...
										echo '</div>';
										 ...
										 if(!empty($sitting_array)){
										 echo '<div class="faq-text">';
										 echo '<label>Physiotherapy</label>';
										 echo '<table class="table table-striped table-bordered table-hover" width="30%">
														<thead>
														<tr>
														...
														<tbody>';
										foreach($sitting_array as $key => $values){
											$time=$values['time'];
											$timeline_id=$values['timeline_id'];
											$timeline_message=$values['timeline_message'];
												
													echo '<tr><td>'.$timeline_type_name.'</td><td>'.$timeline_sitting.'</td></tr>';
		 ...
		 <?php if($activitychart==1 && empty($inv_pat_id)) {?>
	  ...
	  <div class="col-md-12">
       ...
       <div class="panel panel-default" style="background-color: rgb(238, 238, 238)">
          ...
          <div class="panel-body">		
            ...
            <div class="col-md-7" >
                        <select name="service3" id="service3" class="select" style="font-weight:bold;">
                        <option value="">select</option>
                    <?php 
					include("config_db1.php");
					$cmd_ser = "select * from service_creation";
            ...
            <div class="col-md-3">
                 <input type="text" style="font-weight:bold"  class="form-control" name="service_no3" id="service_no3"/>             
            </div>   
          
												
													<div class="col-md-2">
														<a href="#"  onClick="add_service2(service3.value,service_no3.value,chart_ot_no2.value);return false;" class="btn btn-default btn-rounded btn-condensed btn-sm pull-right"><span class="fa fa-plus"></span></a>         </div> 
				...
				<center>
                        ...
                        <tbody>
                         <?php 
					include("config_db2.php");
					$cmd = "select * from services_details where patient_id='$patient_id' AND paid_status !=1 AND bill_queue='0'";
					$i=1;
					$res = mysql_query($cmd);
					while($rs = mysql_fetch_array($res)){
						$insert_from='CHART';
				...
				?>
					...
					<div class="col-md-8">
                                        <input name="submit" id="submit" class="btn btn-primary" value="submit" type="button" onClick="add_ot_chart()">
                                                   </div> 
	  </div>
      <?php 
		 }					
      ...
      <div class="tab-pane" id="tab-second">
        <div class="row">
						...
						?>
										...
										<div class="col-md-4">
                                           <label class="col-md-3  control-label" >Complaints:</label> 
                                             <div class="col-md-7" >
                                                             <input type="text" style="font-weight:bold"  class="form-control" name="complaints_value" id="complaints_value"/>             
</div>
                                                     <div class="col-md-2">
                <a href="#"  onClick="add_others('#complaints_value','#complaints_value_div','complaints',complaints_value.value);return false;" class="btn btn-default btn-rounded btn-condensed btn-sm pull-right"><span class="fa fa-plus"></span></a>            </div>                                
												   </div>
												   <div class="col-md-12">
												   <br>
				<center>
                <div id="complaints_value_div"  class="col-md-6">
					<table id="complaints_value_table" class="table table-striped table-bordered table-hover">
                        <thead>
                        <tr>
                        <th>#</th>
                        <th>Complaints</th>
                        ...
                        <tbody id="complaints_value_tbody" name="complaints_value_tbody">
                         
				  <?php 
					include("config_db2.php");
					$cmd = "select id,reason from clinical_others  where patient_id='$patient_id' AND clinical_history_id='' AND  type='complaints' order by id asc";
					$i=1;
			$res = mysql_query($cmd);
			while($rs = mysql_fetch_array($res)){
			if($rs['role']==1)
			...
			$role="Lab";
						...
						<td>
						<a href="javascript:delete_id(\''.$rs['id'].'\',\'#complaints_value_div\')" class="btn btn-danger btn-condensed"><span class="fa fa-times"></span></a></td>
					</tr>';
					}
				?> 
										  </tbody>
				...
				<div class="form-group">
                                        <div class="col-md-1">
                                             <div class="col-md-1" >
												   ...
												   <div class="col-md-2">
                                           <label class="col-md-2 " >BP:</label> 
                                             <div class="col-md-1" >
                                            <input name="bp" id="bp" type="textbox" value="">Hg/mm</div>
                                           ...
                                           <label class="col-md-2 " >Temp:</label> 
                                             <div class="col-md-1" >
                                            <input name="temp" id="temp" type="textbox" value="">`C</div>
                                                                                    
												   </div>
												   
												   <div class="col-md-2">
                                           <label class="col-md-2 " >Pulse:</label> 
                                             <div class="col-md-1" >
                                            <input name="pulse" id="pulse" type="textbox" value="">/min</div>
                                                                                    
												   </div>
												   
												   <div class="col-md-2">
                                           <label class="col-md-2 " >Wt:</label> 
                                             <div class="col-md-1" >
                                            <input name="wt" id="wt" type="textbox" value="">kg</div>
                                                                                    
												   </div>
												   
												   <div class="col-md-2">
                                           <label class="col-md-2 " >Ht:</label> 
                                             <div class="col-md-1" >
                                            <input name="ht" id="ht" type="textbox" value="">cm</div>
										...
										<!----------CLINICAL FINDINGS----------->
											...
											<div class="col-md-3">
                                            <label class="col-md-2 " >Pallor:</label> 
                                            <div class="col-md-1" >
                                            <input name="pallor" id="pallor" type="textbox" value=""></div>
                                            </div>
											
											<div class="col-md-3">
                                            <label class="col-md-2 " >Icterus:</label> 
                                            <div class="col-md-1" >
                                            <input name="icterus" id="icterus" type="textbox" value=""></div>
                                            </div>
											
											<div class="col-md-3">
                                            <label class="col-md-2 " >Clubbing:</label> 
                                            <div class="col-md-1" >
                                            <input name="clubbing" id="clubbing" type="textbox" value=""></div>
                                            </div>
											
											<div class="col-md-3">
                                            <label class="col-md-2 " >Cyanosis:</label> 
                                            <div class="col-md-1" >
                                            <input name="cyanosis" id="cyanosis" type="textbox" value=""></div>
                                            </div>
											
											</div>
											
											<!------CLINICAL FINDINS PART 2------>
											<div class="form-group">
                                            <div class="col-md-1">
                                            <div class="col-md-1" >
                                            </div>
											...
											<div class="col-md-3">
                                            <label class="col-md-2 " >Lymph Nodes:</label> 
                                            <div class="col-md-1" >
                                            <input name="ln" id="ln" type="textbox" value=""></div>
                                            </div>
											
											<div class="col-md-3">
                                            <label class="col-md-2 " >DD:</label> 
                                            <div class="col-md-1" >
                                            <input name="ef" id="ef" type="textbox" value=""></div>
                                            </div>
											
											<div class="col-md-3">
                                            <label class="col-md-2 " >NS:</label> 
                                            <div class="col-md-1" >
                                            <input name="oc" id="oc" type="textbox" value=""></div>
                                            </div>
											
											<div class="col-md-3">
                                            <label class="col-md-2 " >Others:</label> 
                                            <div class="col-md-1" >
                                            <input name="oh" id="oh" type="textbox" value=""></div>
                                            </div>
...
<div class="col-md-4">
			...
			$role="Lab";
				...
				?> 
                                           ...
                                           <label class="col-md-3  control-label" >Diagnosis:</label> 
                                             <div class="col-md-7" >
                                                             <input type="text" style="font-weight:bold"  class="form-control" name="diagnosis_value" id="diagnosis_value"/>             
</div>
                                                     <div class="col-md-2">
                <a href="#"  onClick="add_others('#diagnosis_value','#diagnosis_value_div','diagnosis',diagnosis_value.value);return false;" class="btn btn-default btn-rounded btn-condensed btn-sm pull-right"><span class="fa fa-plus"></span></a>            </div>                                
												   </div>
												   <div class="col-md-12">
												   <br>
				<center>
                <div id="diagnosis_value_div"  class="col-md-6">
					<table id="diagnosis_value_table" class="table table-striped table-bordered table-hover">
                        <thead>
                        <tr>
                        <th>#</th>
                        <th>Diagnosis</th>
                        ...
                        <tbody id="diagnosis_value_tbody" name="diagnosis_value_tbody">
                         
				  <?php 
					include("config_db2.php");
					$cmd = "select id,reason from clinical_others  where patient_id='$patient_id' AND clinical_history_id='' AND  type='diagnosis' order by id asc";
					$i=1;
			$res = mysql_query($cmd);
			while($rs = mysql_fetch_array($res)){
			if($rs['role']==1)
			...
			$role="Lab";
						...
						<td style="display:none;">'.$rs['id'].'</td>
						<td>
						<a href="javascript:delete_id(\''.$rs['id'].'\',\'#diagnosis_value_div\')" class="btn btn-danger btn-condensed"><span class="fa fa-times"></span></a></td>
					</tr>';
					}
				?> 
										  </tbody>
...
?>
      ...
      <div class="tab-pane " id="tab-four">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php
			include("config_db2.php");
					$cmd_ser1 = "select ref_id from chart_ot order by id desc limit 1";
					$res_ser1 = mysql_query($cmd_ser1);
					while($rs_ser1 = mysql_fetch_array($res_ser1)){
								$ref_no=$rs_ser1['ref_id'];
					}
          ...
          <div class="col-md-4"><div class="col-md-12">
            <div class="col-md-7" style="padding-right:20px;">
                    ...
                    <?php 
					include("config_db1.php");
					$cmd_ser = "select service_name,types,amount,id from service_creation";
					$res_ser = mysql_query($cmd_ser);
					while($rs_ser = mysql_fetch_array($res_ser)){
								$service_name=$rs_ser['service_name'];
								$types=$rs_ser['types'];
 ...
 <div class="col-md-8"><div class="col-md-12">
            <div class="col-md-4">
                    ...
                    <?php 
					include("config_db1.php");
					$cmd_ser = "select procedure_name,ptypes,pamount,id from procedure_creation";
					$res_ser = mysql_query($cmd_ser);
					while($rs_ser = mysql_fetch_array($res_ser)){
								$procedure_name=$rs_ser['procedure_name'];
								$ptypes=$rs_ser['ptypes'];
          ...
          <div class="col-md-4">
                    ...
                    <?php 
					include("config_db1.php");
					$cmd_ser = "select doctor_name,id from doctor_creation";
					$res_ser = mysql_query($cmd_ser);
					while($rs_ser = mysql_fetch_array($res_ser)){
								$doctor_name=$rs_ser['doctor_name'];
								$id=$rs_ser['id'];
         ...
         <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-1">
                     ...
                     <?php 
					include("config_db1.php");
					$cmd = "select id,room from room_no";
					$i=1;
					$res = mysql_query($cmd);
					while($rs = mysql_fetch_array($res)){
						?>
...
//alert('');
      ...
      <div class="tab-pane" id="tab-five">
        <div class="row">
          <div class="col-lg-12">
			...
			<div class="col-md-2">
			<center>
				<input type="checkbox" id="prescription_manual_entry" name="prescription_manual_entry"  style="height:25px; width:20px;" onClick="prescription_manual_entry_click();"/>
				<span class="help-block">Manual Entry</span> 
				</center>                                                
			</div>  
              <div class="col-lg-3">
                ...
                <span class="help-block" for="tablet">Search Tablet list</span> </div>
				<datalist id="tabletlist">
				  <?php
				  include("config_db3.php");
				  $cmd_ser = "select productname from tbl_productlist order by productname ASC ";
						$res_ser = mysql_query($cmd_ser);
				...
				<div class="col-lg-1">
				 <input type="text" tabindex="1" name="seltype" id="seltype" class="form-control"  readonly />
                
                <span class="help-block" >Type</span> </div>
              <div class="col-lg-3">
                <input type="text" tabindex="1" name="generic" id="generic" class="form-control"  readonly />
                <span class="help-block">Generic list</span> </div>
		  ...
		  <div class="col-lg-12">
            <div class="form-group">
				<div class="col-lg-3" for="tablet_availablequantity">
	 ...
	 $cmd_lab_sample_query = mysql_query("select id,labsampleno,sampletesttitle,datereq from lab_testsample_ip WHERE datereq !='' AND patient_id='$patient_id' order by id desc");
...
?>
                ...
                <select multiple="multiple" name="multi_inves" tabindex="9" id="multi_inves" data-live-search="true" class="form-control multiselect">
				
				<?php
	 while($cmd_lab_sample_array = mysql_fetch_array($cmd_lab_sample_query)){
		
					$sampleid = $cmd_lab_sample_array['id'];
					...
					$datereq = $cmd_lab_sample_array['datereq'];
					 $cmd_lab_sample_exists = mysql_query("select slno from prescriptiondetail WHERE FIND_IN_SET('$sampleid', labsampleno) > 0 AND patientid='$patient_id' GROUP BY labsampleno ");
					if(mysql_num_rows($cmd_lab_sample_exists)==0){
			?>
                  <option value="<?php echo $sampleid; ?>"><?php echo $labsampleno.'-'.$sampletesttitle.'-'.$datereq;  ?></option>
...
?>
        ...
        <script>
		function prescription_manual_entry_click()
		{
			if($('#prescription_manual_entry').is( ":checked" )){
				$("span[for='tablet']").html('Enter Tablet Name');
				$("#tablet").removeAttr('list');
				$('#tablet').val('');
				$('#seltype').val('').attr('readonly', false);
				$('#generic').val('').attr('readonly', false);
				$('#txtbrand').val('').attr('readonly', false);
				$('#tablet_availablequantity').val('');
				$("#tablet_orderquantity").val('');
				$('#drugid').val('');
				$('div[for="tablet_availablequantity"]').css('display','none');
				
			}else{
					$("span[for='tablet']").html('Search Tablet list');
					$("#tablet").attr('list','tabletlist');
					$('#tablet').val('');
					$('#seltype').attr('readonly', true);
					$('#generic').attr('readonly', true);
					$('#txtbrand').attr('readonly', true);
					$('#tablet_availablequantity').val('');
					$("#tablet_orderquantity").val('');
					$('#drugid').val('');
					$('div[for="tablet_availablequantity"]').css('display','block');
			}
		}
	...
	//alert('');
		if($("#tablet").val()!= ''){
			if($("#duration").val()!= '' && $("#frequency").val()!= ''){
				var brand="";
				if(calc_quantity() == false){
					return false;
				}
					var brand = $("#seltype").val() + '--' + $("#tablet").val()+ '--' +  $("#txtbrand").val();
				if($('#prescription_manual_entry').is( ":checked" )){
						var prescription_manual_entry = 'manual';
				}else{
						var prescription_manual_entry = 'auto';
				}
				var multi_inves = $("#multi_inves").val();
				
				if(typeof multi_inves === 'undefined'){
					var multi_inves = '';
				}
				...
				var appendTxt = '<tr>'+
					...
					'<td style="display:none;">'+prescription_manual_entry+'</td>'+
					'<td style="display:none;">'+multi_inves+'</td>'+
				...
				alert('Fields (Duration & Frequency) cannot be left blank!');
			}
		}else{
			alert('Tablet field cannot be left blank2!');
		}
            ...
            <table id="pretable" class="table table-bordered table-striped table-actions">
              <thead>
                <tr>
				  ...
				  <th style="display:none;">LAB Sample</th>
                  <th>actions</th>
                </tr>
              </thead>
              <tbody>
...
$(function(){
	...
	//$('.pickdate').datetimepicker({ format: 'dd-MM-yyyy hh:mm:ss' });	
	 $('#intimedate2,#outtime2').datetimepicker({
...
function getAvail(){
 ...
 function checksampleexternal(checkbox){
		//$('#confirm_infomsg').modal('show');
		$("#confirm_infomsg .infomsg").empty();
		if (checkbox.checked) {
			var msg ='Test Sent to External Lab. Please confirm.';
		}else{
			var msg ='Test Sent to Internal Lab. Please confirm.';
		}
		...
		$.ajax({
			type: "post",
			url: "lab_investigation_sentexternal.php",
			data: {
			id:id,
			external:external,
		},
...
function investigation(){
 ...
 $(document).ready(function() {
	...
	$.ajax({
		...
		success: function(msg) {
			var availableTags = msg.split("~");
			$( "#uplstsym,#lstsym,#pid" ).autocomplete({
			  source: availableTags
			});
		}
	});
 ...
 $.ajax({
		...
		success: function(msg) {
			var availableTags = msg.split("~");
			$( "#uplstpsysym,#lstpsysym" ).autocomplete({
			  source: availableTags
			});
		}
	});
...
function add_ot_chart()
{	
	
	var pat_id = '<?php echo $patientid; ?>';
		if (pat_id == "") {
...
*/	
	...
	if (service_no2 == "") {
		...
		$.ajax({
			...
			success: function(msg) {
				jQuery("#service3_list_div").html(msg);	
	...
	if (service_no2 == "") {
		...
		$.ajax({
			...
			success: function(msg) {		
				...
				jQuery("#service2_list_div,#service3_list_div").html(msg);	
				//$('#service_no2').val('');
				//$('#service2').val('');
				//$('#consultant2').val('');
				//$('#fees_amount2').val('');
...
$(function() {
  ...
  var href_id = $("ul.nav-tabs li:eq(0) a").attr('href');
  $(href_id).addClass("active");
//Allow numeric only  
