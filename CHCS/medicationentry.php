<?php
	...
	$user = $_SESSION['username'];
			...
			$sql ="INSERT INTO prescriptiondetail (id, patientid, drugname, dosage, specification, frequency, route, duration,prescribed_by,ip_id,type,tablet,generic,brands,avail_quantity,order_quantity,datetime,drugid,labsampleno) VALUES ('$maxid', '$patid', '$key[1]', '$key[8]', '$key[9]', '$key[10]', '$key[11]', '$key[12]' ,'$user','$ip_id','$key[2]','$key[3]','$key[4]','$key[5]','$key[6]','$key[7]','$datetime','$key[13]','$key[15]')";
					include("config_db2.php");
