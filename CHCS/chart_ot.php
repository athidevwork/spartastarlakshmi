...
<!-- 1 ROW END  -->   
        ...
        <div class="form-group">
            <div class="col-md-4">
				...
				?>
                    <input type="datetime" style="font-weight:bold;width:160px;"  class="form-control" name="intimedate" id="intimedate" value="<?php echo date("Y-m-d h:i:sa", $d);?>"/>
                </div>                                        
            </div>
            <div class="col-md-4">
            <?php
...
<!-- 8 ROW END  -->          
        <div class="form-group">
            <div class="col-md-4">
				...
				$d=mktime(11, 14, 54, 8, 12, 2014);
				?>
                    <input type="datetime" style="font-weight:bold;width:160px;"  class="form-control" name="outtime" id="outtime" value="<?php echo date("Y-m-d h:i:sa", $d);?>"/>
                </div> 
            </div>                
        </div>
<!-- 9 ROW END  -->  
