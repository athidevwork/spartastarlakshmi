...
include("config_db2.php");
	...
	if($ref_no != ""){
		$cmd = "INSERT INTO consultant_details (id,ref_no,insert_from,department,consultant,visit,created_date,fee,patient_id,ip_no,intime,added_by) VALUES (NULL, '$ref_no','CHART','$depart','$consultant','$visit','$created_date','$fee','$pid','$pat_ip_id','$intime','$user')";
	}
	include("config_db2.php");
