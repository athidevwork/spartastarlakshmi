...
?>
					...
					$cmd_lab_sample_query = mysql_query("select id,patient_id,ip_id,labsampleno,testtotalamt,sampletesttitle,datecollect from lab_testsample_ip WHERE patient_id='$patient_id' AND paid_status !=1 AND bill_queue ='1' order by id desc");		
					...
					while($rs = mysql_fetch_array($cmd_lab_sample_query)){
						...
						<td><?php echo $rs['sampletesttitle']; ?></td>
