        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
                    ...
                    <li class="xn-search">
                        <form role="form">
                            <input type="text" name="ser" id="ser"  onBlur="get(),get_details(),get_sum_total()" placeholder="Search Patient for billing..."/>
                                    ...
                                    <div class="panel-body">                                    
                                        <div class="form-group">
										 <div class="col-md-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text"  style="font-weight:bold" readonly class="form-control" name="pat_id" id="pat_id"/>
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" style="font-weight:bold" readonly class="form-control" name="name" id="name"/>
                                                  <span class="help-block"></span>  
												</div>                                        
												   </div>       
										 ...
										 <div class="col-md-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" style="font-weight:bold" readonly class="form-control" value="<?php echo date("d/m/Y"); ?>" name="date"/>
                                               <span class="help-block"></span> 
												</div>                                        
												   </div>
										</div>	
                                        <div class="form-group">
										 <div class="col-md-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text"  style="font-weight:bold" readonly class="form-control" name="ip_id" id="ip_id"/>
                                                <span class="help-block"></span> 
												</div>                                        
												   </div>
                                                   </div>   
										 ...
										 <div class="col-md-4">
                                            ...
                                            <div class="col-md-9">
                                              ...
                                              <span class="help-block"></span> 
												   ...
												   <div class="col-md-1">
                                           <a href="#"  onClick="get_total_amt(pat_id.value),get_list(),add_fees_sublist(pat_id.value,name.value,ip_id.value,des.value,fees.value);" class="btn btn-default btn-rounded btn-condensed btn-sm pull-left"><span class="fa fa-plus"></span></a>                                   
												   </div>     
										</div>
										<div class="col-md-12">
