...
include("config_db2.php");
	...
	if($chart_ot_no != ""){
		$cmd = "INSERT INTO chart_ot (id,ref_id,insert_from,room_no,name,age,doa,cons,intimedate,description,shift_patient,outtime,vacant_chk,created_date) VALUES (NULL, '$chart_ot_no','CHART ICU','$room_no','$name','$age','$doa','$cons','$intimedate','$descriptions','$shift_patient','$outtime','$vacant_chk','$created_date')";
