...
include("config_db2.php");
	...
	if($ref_no != ""){
		$cmd = "INSERT INTO consultant_details (id,ref_no,insert_from,department,consultant,visit,created_date) VALUES (NULL, '$ref_no','CHART OT','$depart','$consultant','$visit','$created_date')";
	}
