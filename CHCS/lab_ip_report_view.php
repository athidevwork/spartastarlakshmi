...
class VariableStream{
 ...
 $sampleno=$_REQUEST['sampleno'];
	 ...
	 $cmd_lab_sample_query = mysql_query("select id,patient_id,ip_id,labsampleno,sampletesttitle,sampletestsubtitle,sampleapprover,sampleapproverdesign,datereq,datecollect,datereportgen,createby from lab_testsample_ip WHERE labsampleno='$sampleno' order by id desc limit 1");
...
$pdf->Ln(.4);
$pdf->MultiCell(6.3, 0.25, "LAB Tests" , '0', "C");
$pdf->Ln(.3);
...
$pdf->SetFont('arial','',10);
$pdf->Cell(1.1, 0, 'Internal Ref No', '0', "L");
$pdf->SetFont('arial','',10);
...
$pdf->SetFont('arial','',10);
$pdf->Cell(1.1, 0, 'Doctor Name', '0', "L");
$pdf->SetFont('arial','',10);
$pdf->Cell(1.1, 0, ': '.$createby, '0', "L");
$pdf->Ln(.2);
$pdf->SetFont('arial','',10);
...
$pdf->Ln(0);
$pdf->Cell(2, 0.25, 'Investigation Types and Tests', '0', 'C');
$pdf->Ln(0.3);
