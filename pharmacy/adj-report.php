    ...
    <div class="main-content-inner">
      <div class="page-content">
        <div class="page-header">
            <h1> Report <small> <i class="ace-icon fa fa-angle-double-right"></i> Stock Adjustment Report </small> </h1>
          </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="center"> <br />
             ...
             <form class="form-horizontal">
              ...
              <br />
             <table id="tbl-adj-rpt" class="table table-fixed">
<thead>
  <tr>
...
function rptPrintXLS(){
	...
	window.open("manage-report/excel-adj-report.php?"+data)
}
function rptDisplay(){
	var d1 = $('#dtfrom').val(), d2 = $('#dtto').val();
	...
	$.ajax({
		type: 'post',
		url: 'manage-report/return-adj-report.php',
		data: {
			fromdate: d1,
			fromto: d2,
			//paymentmode: pm,
		...
		success: function(msg) {
			...
			for(var i = 0; i < x.length - 1; i++){
				var tr = "<tr><td>"+x[i].date+"</td><td>"+x[i].productname+"</td><td>"+x[i].qty+"</td><td>"+x[i].batchno+"</td><td>"+x[i].expiry+"</td><td>"+x[i].adjtype+"</td><td>"+x[i].adjreason+"</td><td>"+x[i].username+"</td></td></tr>";
				 $(table).append(tr);
			}
