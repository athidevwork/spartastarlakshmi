...
<?php
	...
	if($_SESSION['mp'] == 1 ||	$_SESSION['mm'] == 1 ||	$_SESSION['ms'] ==1 || $_SESSION['mu'] == 1){
		...
		if($_SESSION['mm'] == 1) echo '<li class="active open hover highlight"> <a href="manage-manufacturer.php"> <i class="menu-icon fa fa-caret-right"></i> Manage Manufacturer </a> <b class="arrow"></b> </li>';
      ...
      <div class="main-content-inner">
        <div class="page-content">
          <div class="page-header">
            <h1> Master Entry <small> <i class="ace-icon fa fa-angle-double-right"></i> Manage Doctor </small> </h1>
          </div>
          <div class="row">
            <div class="col-xs-12">
              <div class="row">
                <div class="col-xs-12">
                  <div class="table-header"> List of Doctors 
				  <a data-toggle="modal" data-target="#modal-new-doctor" class="pull-right" style="margin-right:15px;color:#FFFFFF;text-decoration:none;cursor:pointer;"><i class="ace-icon fa fa-user"></i>  Add New doctor </a>				  </div>
                  <div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header no-padding">
                      <div class="table-header">Doctor Information</div>
                    </div>
			  ...
			  <div id="modal-update" class="modal fade" tabindex="-1">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header no-padding">
                      <div class="table-header">Update Doctor Information</div>
                    </div>
					<div class="modal-body no-padding">
                      <div class="col-xs-12">
                        ...
                        <table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
                          <tr>
                            <th scope="row" style="vertical-align:middle;">Name</th>
                            <td colspan="3"><input type="hidden" id="DBid" name="DBid"><input type="text" id="udoctor" name="udoctor" placeholder="doctor Name"></td>
                          </tr>
                          <tr>
                            <th rowspan="4" scope="row" style="vertical-align:middle;">Address</th></tr>
                    ...
                    <div class="modal-footer no-margin-top">
					  <button class="btn btn-sm btn-info pull-right" data-dismiss="modal"> <i class="ace-icon fa fa-times"></i> Close </button>
                      <input type="button" class="btn btn-sm btn-primary pull-right" value="Update" onClick="updatedoctor()" style="margin-right:10px;"/>
                    </div>
                  </div>
                </div>
              </div>
			  <div id="modal-new-doctor" class="modal fade" tabindex="-1">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header no-padding">
                      <div class="table-header">New Doctor Information</div>
                    </div>
                    <div class="modal-body no-padding">
                      <div class="col-xs-12">
					  	<form id="newdoctor">
                        <table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
                          <tr>
                            <th scope="row" style="vertical-align:middle;">Name</th>
                            <td colspan="3"><input type="text" id="doctor" name="doctor" placeholder="doctor Name"></td>
                          </tr>
                          <tr>
                            <th rowspan="4" scope="row" style="vertical-align:middle;">Address</th></tr>
                    ...
                    <div class="modal-footer no-margin-top">
					  <button class="btn btn-sm btn-info pull-right" data-dismiss="modal"> <i class="ace-icon fa fa-times"></i> Close </button>
                      <input type="button" class="btn btn-sm btn-primary pull-right" value="Save" onClick="newdoctor()" style="margin-right:10px;"/>
                    </div>
                  </div>
                </div>
              </div>
...
<script src="manage-doctor/manage-doctor.js"></script>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		$('#table-user-list').dataTable( {
			bAutoWidth: false,
			"bProcessing": true,
			"sAjaxSource": "manage-doctor/return-doctor-list.php",
			"aoColumns": [
