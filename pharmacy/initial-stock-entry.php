...
<?php
	...
	if($_SESSION['sa'] == 1 || $_SESSION['ise'] == 1 || $_SESSION['stka'] == 1){
		...
		if($_SESSION['sa'] == 1) echo '<li class="hover"> <a href="stock-availability.php"> <i class="menu-icon fa fa-caret-right"></i> Stock Availability </a> <b class="arrow"></b> </li>';
		if($_SESSION['ise'] == 1) echo '<li class="active open hover"> <a href="initial-stock-entry.php"> <i class="menu-icon fa fa-caret-right"></i> Initial Stock Entry </a> <b class="arrow"></b> </li>';
      ...
      <div class="page-content">
        ...
        <div class="row">
          <div class="col-xs-12">
			...
			<?php
				include("config.php");
				$res1 = mysql_query("SELECT * FROM tbl_purchaseitems WHERE status = 3");
				while($r = mysql_fetch_array($res1)){
					$id = $r['productid'];
					$sql = "SELECT * FROM tbl_productlist WHERE id = '$id'";
					$res = mysql_query($sql);
					$rs = mysql_fetch_array($res);
					echo "<tr><td>".$r['productid']."</td><td>".$rs['productname']."</td><td>".$r['qty']."</td><td>".$r['batchno']."</td><td>".$r['expirydate']."</td><td>".$r['mrp']."</td><td><img src='images/delete.png' style='width: 24px; cursor: pointer;' onClick='javascript:deleteItem(this,".$r['id'].")' /></td></tr>";
				}
			?>
            </tbody>
          </table>
